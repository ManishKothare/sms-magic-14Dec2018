...
<div class="row blog blogPosts <?php echo (isset($hgr_options['blog_color_scheme']) ? esc_attr( $hgr_options['blog_color_scheme'] ) : '');?>">
  <div class="container"> 
    ...
    <div class="vc_col-sm-8">
      ...
      <h1 class="titleSep" style="color:#2d9cdb;"><?php esc_html_e( 'Daily Archives:', 'navy' );?>
        <?php the_time( 'F jS, Y' ); ?>
      </h1>
      <?php /* If this is a monthly archive */ } elseif ( is_month() ) { ?>
      <h1 class="titleSep" style="color:#2d9cdb;"><?php esc_html_e( 'Monthly Archives:', 'navy' );?>
        <?php the_time( 'F, Y' ); ?>
      </h1>
      <?php /* If this is a yearly archive */ } elseif ( is_year() ) { ?>
      <h1 class="titleSep" style="color:#2d9cdb;"><?php esc_html_e( 'Yearly Archives:', 'navy' );?>
        <?php the_time( 'Y' ); ?>
      </h1>
      <?php } ?>
